//import styles from './worker-order-workshop-form.module.css';
...
import { WorkerField } from "@shared/components";
import { useForm } from "@tanstack/react-form";
import type { AxiosError } from "axios";
import { useMemo } from "react";

export interface WorkerOrderWorkshopFormProps { }

const id = "WorkerOrderWorkshopForm"
export const WorkerOrderWorkshopForm = ({ }: WorkerOrderWorkshopFormProps) => {
    ...
    >
      <Grid justify='center' align='center'>
        <Grid.Col span={{ base: 12 }}>
          <WorkerField name="worker" form={form} />
        </Grid.Col>
      </Grid>
    </DrawerStack>
  );
};
WorkerOrderWorkshopForm.id = id
